...
class EditLetterPage extends StatefulWidget {
  ...
  const EditLetterPage({Key? key, required this.imagePaths}) : super(key: key);

  @override
  State<EditLetterPage> createState() => EditLetterPageState(imagePaths: imagePaths);
}
...
class EditLetterPageState extends State<EditLetterPage> {
  ...
  EditLetterPageState({required this.imagePaths});
